...
-- Creo la tabella Prenotazione-Pizza-Aggiunta per la relazione n-n-n tra Prenotazione, Pizza e Aggiunta
CREATE TABLE PRENOTAZIONE_PIZZA_AGGIUNTA(
    ID BIGINT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
    ID_PRENOTAZIONE BIGINT UNSIGNED NOT NULL,
    ID_PIZZA BIGINT UNSIGNED,
    ID_AGGIUNTA BIGINT UNSIGNED,
